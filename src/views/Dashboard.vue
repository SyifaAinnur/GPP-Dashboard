    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <process-info-box
          ...
          number="114,381"
          :progress="70"
          description="70% increase since yesterday"
        >
        </process-info-box>
      </div>
      <!-- /.col -->
...
import InfoBox from "../views/widgets/infoBox.vue";
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      new Chart(pieChartCanvas, pieConfig);

      var pieChartCanvas = document.getElementById("Overview").getContext("2d");
      var pieConfig = {
        type: "pie",
        data: {
          labels: ["HTML", "JavaScript", "CSS"],
